...
1. [osquery](https://github.com/facebook/osquery) ⭐ 23,582 | 🐛 609 | 🌐 C++ | 📅 2026-09-17 - Cross-platform tool for data collection and forensic analysis.
2. [Santa](https://github.com/google/santa) ⚠️ Archived - Binary whitelisting/blacklisting system.
3. [Malimite](https://github.com/LaurieWired/Malimite) ⭐ 3,191 | 🐛 14 | 🌐 Java | 📅 2025-08-26 - iOS and macOS Decompiler
...
16. [Lockpaw](https://github.com/sorkila/lockpaw) ⭐ 153 | 🐛 3 | 🌐 Swift | 📅 2026-09-15 - macOS menu bar screen guard that locks and unlocks your display with a hotkey. Open source, no telemetry.
17. [Raccoon](https://github.com/thousandflowers/Raccoon) ⭐ 130 | 🐛 1 | 🌐 Shell | 📅 2026-09-18 - CLI toolkit for macOS security audits, fleet management via SSH, baseline drift detection, and remediation reports. Zero dependencies, agentless.
...
24. [macharden](https://github.com/jankesec/macharden) ⭐ 5 | 🐛 0 | 🌐 Shell | 📅 2026-09-15 - Enterprise-grade macOS security audit, posture assessment, and baseline drift engine. 54 CIS/NIST/MITRE controls, OASIS SARIF v2.1.0, and interactive Liquid Glass HTML5 dashboard.
...
1. [DVIA v2](https://github.com/prateek147/DVIA-v2) ⭐ 1,112 | 🐛 9 | 🌐 Swift | 📅 2024-03-29 - Damn Vulnerable iOS App v2 for learning
...
1. [objection](https://github.com/sensepost/objection) ⭐ 9,400 | 🐛 57 | 🌐 Python | 📅 2026-09-17 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak
2. [LibiMobileDevice](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,199 | 🐛 846 | 🌐 C | 📅 2026-06-10 - A cross-platform protocol library to communicate with iOS devices
...
4. ~~[Needle](https://github.com/mwrlabs/needle) ⚠️ Archived - iOS App Pentesting Tool.~~ Abandoned in 2025. The devs recommend using [objection](https://github.com/sensepost/objection) ⭐ 9,400 | 🐛 57 | 🌐 Python | 📅 2026-09-17 instead
