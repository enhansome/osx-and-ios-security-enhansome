...
1. [osquery](https://github.com/facebook/osquery) ⭐ 23,532 | 🐛 633 | 🌐 C++ | 📅 2026-08-25 - Cross-platform tool for data collection and forensic analysis.
...
12. [Pareto Security](https://github.com/paretoSecurity/pareto-mac/) ⭐ 453 | 🐛 9 | 🌐 Swift | 📅 2026-08-30 - A MenuBar app to automatically audit your Mac for basic security hygiene.
...
17. [Raccoon](https://github.com/thousandflowers/Raccoon) ⭐ 130 | 🐛 1 | 🌐 Shell | 📅 2026-08-30 - CLI toolkit for macOS security audits, fleet management via SSH, baseline drift detection, and remediation reports. Zero dependencies, agentless.
...
1. [objection](https://github.com/sensepost/objection) ⭐ 9,354 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak
2. [LibiMobileDevice](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,159 | 🐛 848 | 🌐 C | 📅 2026-06-10 - A cross-platform protocol library to communicate with iOS devices
...
4. ~~[Needle](https://github.com/mwrlabs/needle) ⚠️ Archived - iOS App Pentesting Tool.~~ Abandoned in 2025. The devs recommend using [objection](https://github.com/sensepost/objection) ⭐ 9,354 | 🐛 55 | 🌐 Python | 📅 2026-07-23 instead
