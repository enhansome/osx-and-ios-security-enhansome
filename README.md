...
1. [osquery](https://github.com/facebook/osquery) ⭐ 23,557 | 🐛 642 | 🌐 C++ | 📅 2026-09-09 - Cross-platform tool for data collection and forensic analysis.
2. [Santa](https://github.com/google/santa) ⚠️ Archived - Binary whitelisting/blacklisting system.
3. [Malimite](https://github.com/LaurieWired/Malimite) ⭐ 3,186 | 🐛 14 | 🌐 Java | 📅 2025-08-26 - iOS and macOS Decompiler
...
12. [Pareto Security](https://github.com/paretoSecurity/pareto-mac/) ⭐ 456 | 🐛 9 | 🌐 Swift | 📅 2026-08-30 - A MenuBar app to automatically audit your Mac for basic security hygiene.
...
16. [Lockpaw](https://github.com/sorkila/lockpaw) ⭐ 150 | 🐛 1 | 🌐 Swift | 📅 2026-09-09 - macOS menu bar screen guard that locks and unlocks your display with a hotkey. Open source, no telemetry.
17. [Raccoon](https://github.com/thousandflowers/Raccoon) ⭐ 130 | 🐛 1 | 🌐 Shell | 📅 2026-09-09 - CLI toolkit for macOS security audits, fleet management via SSH, baseline drift detection, and remediation reports. Zero dependencies, agentless.
...
1. [objection](https://github.com/sensepost/objection) ⭐ 9,376 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak
2. [LibiMobileDevice](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,175 | 🐛 846 | 🌐 C | 📅 2026-06-10 - A cross-platform protocol library to communicate with iOS devices
...
4. ~~[Needle](https://github.com/mwrlabs/needle) ⚠️ Archived - iOS App Pentesting Tool.~~ Abandoned in 2025. The devs recommend using [objection](https://github.com/sensepost/objection) ⭐ 9,376 | 🐛 57 | 🌐 Python | 📅 2026-07-23 instead
